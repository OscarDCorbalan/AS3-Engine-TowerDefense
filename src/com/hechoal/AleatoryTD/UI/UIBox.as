package com.hechoal.AleatoryTD.UI {
	...
	import com.hechoal.AleatoryTD.Turrets.Turret;
	...
	public class UIBox extends MovieClip{
		...
		private function addButtonFb(btn:fbButton, clk:Function){	
			//btn.makeButton(clk);
			btn.width = 24;
			btn.height = 24;
			addChild(btn);
			MochiServices.addLinkEvent("http://x.mochiads.com/link/0b1e1dc3bf154518", "http://www.facebook.com/LoquatGames", btn);
		}		
		private function addButtonTw(btn:twButton, clk:Function){		
			//btn.makeButton(clk);
			btn.width = 24;
			btn.height = 24;
			addChild(btn);
			MochiServices.addLinkEvent("http://x.mochiads.com/link/bc3a8368a2ed4e03", "https://twitter.com/LoquatGames", btn);
		}
		private function addButtonLg(btn:lgButton, clk:Function){
			//btn.makeButton(clk);
			btn.width = 24;
			btn.height = 26;
			addChild(btn);
			MochiServices.addLinkEvent("http://x.mochiads.com/link/ced6016867005277", "http://www.loquatgames.eu", btn);
		}
		private function fbClick(myEvent:MouseEvent){
			var request:URLRequest = new URLRequest("http://www.facebook.com/LoquatGames");
			navigateToURL(request);
		}
		
		private function twClick(myEvent:MouseEvent){
			var request:URLRequest = new URLRequest("https://twitter.com/LoquatGames");
			navigateToURL(request);
		}
		
		private function lgClick(myEvent:MouseEvent){
